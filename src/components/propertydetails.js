...
const Properties = () => {
  ...
  const handleUpload = async (e) => {
    ...
    await axios.post("https://realestatenewbackend.onrender.com/api/basicinfo/posts", objectname)
      ...
      <div className="new-basic-info-container">
        <div className="row1">
          <div className="content-3">
            ...
            <input type="text" className="content-type" name="Length"  placeholder="Length"/><br />
          </div>
          <div className="content-4">
            <label for="totalArea">Total Area</label><br />
            <input type="text" className="content-type" id="price" value={totalArea} name="totalArea" placeholder="Total Area" onChange={(e) => { setTotalArea(e.target.value);}}/><br />
          </div>
          <div className="content-2">
            <label for="bhk">No Of BHK</label><br />
          ...
          <div className="content-1">
            <label for="fname">Attached</label><br />
          ...
          <div className="content-1">
            <label for="fname">Furnished</label><br />
            <select className="content-type" name="property-type">
              <option value="Yes">Yes</option>
              <option value="No">No</option>
            </select><br />
          ...
          <div className="content-1">
            <label for="fname">Lift</label><br />
            <select className="content-type" name="property-type">
              <option value="house" disabled>Select Lift</option>
              <option value="saab">Yes</option>
              <option value="fiat">No</option>
            </select><br />
          </div>
          <div className="content-1">
            <label for="fname">Facing</label> <br />
            <select className="content-type" name="property-type">
        ...
        <div className="row2">
          <div className="content-3">
            ...
            <input type="text" className="content-type" id="price" name="price" placeholder="Example: 1000"/><br />
          </div>
          <div className="content-1">
            <label for="negotiable">Area Unit</label><br />
          ...
          <div className="content-2">
            <label for="ownership">No Of Floor</label><br />
          ...
          <div className="content-3">
            <label for="property-approved">Western Toilet</label><br />
          ...
          <div className="content-3">
            <label for="bank-loan">Car Parking</label><br />
            <select className="content-type" name="property-approved">
          ...
          <div className="content-3">
            <label for="fname">Electricity</label><br />
            <input type="text" className="content-type" id="price" name="price" placeholder="Example: 3 Phase"/><br />
          </div>
        </div>
      </div>
